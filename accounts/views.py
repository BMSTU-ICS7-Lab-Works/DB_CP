...
def login(request):
    if request.method == 'POST':
        ...
        if form.is_valid():#тут происходит проверка на валидность данных и существование пользователя
...
def registration(request):
    if request.method == 'POST':
        ...
        if form.is_valid():#тут происходит проверка на валидность данных
            username = request.POST.get('username')
